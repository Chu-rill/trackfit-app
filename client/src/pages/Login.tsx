...
import { FireIcon, ArrowLeftIcon, EnvelopeIcon, LockClosedIcon } from '@heroicons/react/24/outline';
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="space-y-4 text-indigo-100">
            <div className="flex items-start space-x-3">
              ...
              <p className="text-lg">Track your nutrition with smart technology</p>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                <span className="text-xs">✓</span>
              </div>
              <p className="text-lg">Achieve your fitness goals faster</p>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                <span className="text-xs">✓</span>
              </div>
              <p className="text-lg">Join thousands of successful users</p>
            </div>
          </div>
        </div>
