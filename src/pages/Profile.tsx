...
import { Gender, UnitPreference, ActivityLevel, BodyStats } from '../types';
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setProfileData({ ...profileData, unit_preference: e.target.value as UnitPreference })
              }
              disabled={!editing}
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white disabled:bg-gray-100 disabled:dark:bg-gray-700"
            >
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Body Stats</h2>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => setStatsData({ ...statsData, weight: e.target.value })}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              Height ({profileData.unit_preference === 'metric' ? 'cm' : 'inches'})
            </label>
            <input
              type="number"
              step="0.1"
              value={statsData.height}
              onChange={(e) => setStatsData({ ...statsData, height: e.target.value })}
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setStatsData({ ...statsData, activity_level: e.target.value as ActivityLevel })
              }
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white"
            >
        ...
        {bodyStats && (
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            <h3 className="font-medium text-gray-900 dark:text-white mb-3">Current Stats</h3>
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <p className="text-gray-500 dark:text-gray-400">Maintenance Calories</p>
                <p className="font-semibold text-gray-900 dark:text-white">
