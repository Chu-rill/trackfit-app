...
import type { BodyStats, FoodLog } from "../types";
import {
  formatWeight,
  formatHeight,
  getBMICategory,
          ...
          <div className="flex">
            <div className="ml-3">
              <p className="text-sm text-yellow-700 dark:text-yellow-400">
                Complete your profile to get personalized calorie and nutrition
                recommendations.{" "}
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        P: {Math.round(log.protein || 0)}g C:{" "}
                        {Math.round(log.carbs || 0)}g F:{" "}
